...
experiment = "pan_amazon_hist_0"

# read model output data
df = pl.read_parquet(f"../outputs/{experiment}biomass_2021.parquet")
b2000 = pl.read_parquet(f"../outputs/{experiment}biomass_1961.parquet")
b0 = pl.read_parquet(f"../outputs/{experiment}biomass_1901.parquet")

# Read PLS_data
pls_df = pl.read_csv("../outputs/pls_attrs-5000.csv")
