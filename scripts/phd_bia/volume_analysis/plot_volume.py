...
NOME_ARQUIVO_CSV = '/Users/biancarius/Desktop/CAETE-DVM-alloc-allom-including_alloc2_Cm2/scripts/volume_analysis/manus/seus_dados.csv' # !! SUBSTITUA PELO NOME DO SEU ARQUIVO !!
