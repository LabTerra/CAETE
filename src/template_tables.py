...
class run_g1(tb.IsDescription):
    ...
    specific_la = tb.Float64Col(dflt=0.0, pos=17)
    ls = tb.Float64Col(dflt=0.0, pos=18)
    nupt1 = tb.Float64Col(dflt=0.0, pos=19)
    nupt2 = tb.Float64Col(dflt=0.0, pos=20)
    pupt1 = tb.Float64Col(dflt=0.0, pos=21)
    pupt2 = tb.Float64Col(dflt=0.0, pos=22)
    pupt3 = tb.Float64Col(dflt=0.0, pos=23)
...
class PLS_temp(tb.IsDescription):
    ...
    sla_random = tb.Float64Col(dflt=0.0, pos=18)
    wd_random = tb.Float64Col(dflt=0.0, pos=19)
    restime_sap = tb.Float64Col(dflt=0.0, pos=20)
...
class spin_snapshots(tb.IsDescription):
    ...
    upt_stratN0 = tb.Float64Col(dflt=0.0, pos=24)
    upt_stratN1 = tb.Float64Col(dflt=0.0, pos=25)
    upt_stratN2 = tb.Float64Col(dflt=0.0, pos=26)
    upt_stratN3 = tb.Float64Col(dflt=0.0, pos=27)
    upt_stratN4 = tb.Float64Col(dflt=0.0, pos=28)
    upt_stratN6 = tb.Float64Col(dflt=0.0, pos=29)
    upt_stratP0 = tb.Float64Col(dflt=0.0, pos=30)
    upt_stratP1 = tb.Float64Col(dflt=0.0, pos=31)
    upt_stratP2 = tb.Float64Col(dflt=0.0, pos=32)
    upt_stratP3 = tb.Float64Col(dflt=0.0, pos=33)
    upt_stratP4 = tb.Float64Col(dflt=0.0, pos=34)
    upt_stratP5 = tb.Float64Col(dflt=0.0, pos=35)
    upt_stratP6 = tb.Float64Col(dflt=0.0, pos=36)
    upt_stratP7 = tb.Float64Col(dflt=0.0, pos=37)
    upt_stratP8 = tb.Float64Col(dflt=0.0, pos=38)

    area_0 = tb.Float64Col(shape=(gp.npls,), pos=39)
    area_f = tb.Float64Col(shape=(gp.npls,), pos=40)
