...
contains
  ...
  function psi_fifty(dwood,cawood1) result(psi_50)
      ...
      real(r_8),intent(in) :: dwood             !variant trait g/cm3
   ...
   function conductivity_xylemleaf(dwood,amax,cawood1) result(kl_max)
