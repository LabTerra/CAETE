...
if __name__ == "__main__":
    ...
    # USE A PRE-GENERATED PLS TABLE
    # Generated by plsgen.py using table_gen function
    if not GENERATE_NEW_PLS_TABLE: # Use pre-generated table
        # Edit the path below to point to your desired PLS table
    ...
    # OR GENERATE PLS TABLE ON THE FLY
        ...
        PLS_TABLE_PATH = PLS_TABLE_DIR / f"pls_attrs-{GLOBAL_NPLS}.csv"
    ...
    # =========================================================================
    # PHASE 2: Spinup - Equilibrate soil carbon pools and sample initial PLSs
    # =========================================================================
    print("[2/7] Running spinup...")
    s1 = time.perf_counter()

    pan_amazon.run_region_map(fn.spinup_fast)
